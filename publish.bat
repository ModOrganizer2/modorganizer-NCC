...
copy "%_NMMPATH%\bin\Release\GameModes\data\boss32.dll" "%outputPath%\NCC\GameModes\data"
copy "%_NMMPATH%\bin\Release\GameModes\data\boss64.dll" "%outputPath%\NCC\GameModes\data"
copy "%_NMMPATH%\bin\Release\GameModes\data\loot32.dll" "%outputPath%\NCC\GameModes\data"
copy "%_NMMPATH%\bin\Release\GameModes\data\loot64.dll" "%outputPath%\NCC\GameModes\data"
